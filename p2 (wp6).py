...
class PokerGame:
        ...
        if Dealer_result == Player_result:
            if Dealer_result == "One Pair":
                ...
                if dealer_pair_rank and player_pair_rank and dealer_pair_rank > player_pair_rank:
                    winner = "Dealer"
                    print("Dealer wins!")
                    self.results_text.setText("Dealer wins!")
                    self.results_text.setFill("red")
                    game_points = -100
                else:
                    winner = "Player"
                    print("Player wins!")
                    self.results_text.setText("Player wins!")
                    self.results_text.setFill("red")
                    game_points = 100
    ...
    def handle_button_click(self):
        click_point = self.win.getMouse()  # Get the mouse click point
